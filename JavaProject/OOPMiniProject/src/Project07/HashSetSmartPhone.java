...
public class HashSetSmartPhone implements ISmartPhone{

	private Set<Contact> contacts;
	Scanner scan;

	private HashSetSmartPhone() {
		contacts = new HashSet<>(10);
		scan = new Scanner(System.in);
	}

	private static HashSetSmartPhone setsp = new HashSetSmartPhone();

	public static HashSetSmartPhone getInstance() {
		if (setsp == null) {
			setsp = new HashSetSmartPhone();
		}
		return setsp;
	}
	...
	public void editContact() {
		...
		if (select == 1) {
			...
			contact = new CompanyContact(searchName, phoneNumber, email, address, birthday, group, company, department,
					position);
			...
			contact = new CustomerContact(searchName, phoneNumber, email, address, birthday, group, company, goods, position);
