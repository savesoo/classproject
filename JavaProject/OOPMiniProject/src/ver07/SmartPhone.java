...
public class SmartPhone {
	...
	private List<Contact00> contacts;
	Scanner sc;
	...
	void editContact() {
		...
		Contact00 contact = contacts.get(searchIndex);
	...
	void insertContact() {
		...
		if (contacts.size() == 10) {
			System.out.println("최대 저장 개수는 " + contacts.size() + "개 입니다.");
			return;
		}
	...
	// List -> 먼저 배열에 있는 객채의 주소값을 찾아(인덱스) 그 안의 요소를 get을 통해 확인 가능(Point)
